...
void Sandbox2D::OnUpdate(Hazel::Timestep ts)
{
...

	{
		...
		Hazel::Renderer2D::DrawQuad({ -0.8f, -0.8f }, { 0.5f, 0.5f }, { 0.2f, 0.3f, 0.8f, 1.0f });
		Hazel::Renderer2D::DrawQuad({ 0.0f, 0.0f, -0.1f }, { 10.0f, 10.0f }, m_ChernoLogoTexture, 10.0f);
		Hazel::Renderer2D::DrawRotatedQuad({ 0.5f, 0.5f, 0.0f }, { 1.0f, 1.0f }, glm::radians(rotation), m_ChernoLogoTexture, 20.0f);
	...
	Hazel::Renderer2D::DrawQuad({ 2.0f, 0.0f, 0.5f }, { 1.0f,1.0f }, m_TextureTree);
	Hazel::Renderer2D::EndScene();
